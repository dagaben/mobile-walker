...
registerPoiDefinition({id:"highland-watchtower",label:"Highland watchtower",biomes:{allowed:["highlands","mountain"],preferred:["highlands"]},...HIGHLAND_WATCHTOWER_CONFIG,spacingByType:{"highland-watchtower":260},weight:1.25,footprint:{kind:"rectangle",width:4.2,depth:4.2},shadowCaster:{width:4,depth:4,height:8.5},hydrology:{rejectRiverIntersection:true},terrain:{maximumSlope:.14,maximumVariation:.6},renderer:"highland-watchtower",debugColor:0xd6c7a0,suitability:c=>c.localProminence<.22?{score:0,reason:"insufficient terrain prominence"}:{score:Math.min(1,.4+c.localProminence*.32+(c.biome.dominant==="highlands"?.12:0)-c.terrain.approximateSlope)}});
